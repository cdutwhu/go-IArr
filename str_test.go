...
func TestSearchStrsIgnore(t *testing.T) {

	fPln(Str("ab C 最t de C d e C. 最t * d TTT 最 e最td #* e *#  #.1C 	* d	 e *# . 最 .fc  * c	d").SearchStrsIgnore("最t", "d", "e", ".1", " \t*#"))
...
func TestRmTailFromLast(t *testing.T) {
	...
	fPln(Str("a~sif~abc~ABC").RmTailFromLastN("~", 2))
}
